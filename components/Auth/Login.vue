                ...
                <v-row class="justify-center">
                  ...
                  <v-col cols="10" align="start" class="pa-0 pl-3">
                    <v-list-item class="pa-0">
                      ...
                      <v-spacer/>
                      <v-btn text @click="forgetPassword" small align="right" class="text-capitalize font-italic"
                             color="info">{{ $t('forget password ?')}}
                      </v-btn>
                    </v-list-item>
                  </v-col>
                </v-row>
                ...
                <v-row class="justify-center">
                  <v-col cols="10">
                    <v-btn
                      ...
                      large
                      rounded
                      class="btn btn-3 mb-10 text-capitalize"
                      :loading="isLoading"
                      @click="userLogin()"
                    >
                      {{ $t('Log in')}}
              ...
              this.$auth
                ...
                .then((response) => {
                  if (response.data.error === false) {
                    //this.$store.commit('permitted/setPermissions', response.data.permissions)
